...
This project analyzes 700,000+ job postings from multiple job platforms to identify trends in data roles, required skills, and geographic demand.
SQL was used to explore and aggregate the dataset, while Tableau was used to build an interactive dashboard for visualizing key insights.
...
To identify highest paying roles, I filtered data analysis roles by average salary and location. Focusing on Berlin where my goal is to live and work in.
...
![Top Paying Roles](/images/toppayingroles.png)
...
![Required Skills For Top Paying Roles](/images/requiredskills.png)
...
![Data Analyst in Germany](images/DAGermany.png)
![Senior DS in General](images/SeniorDSWorld.png)
...
## Closing Thoughts
This project greatly improved my SQL skills as well as Python, Tableau and Git. In addition to that provided me valueable insights about data job market. Those insights will guide me through my process of skill development and job searching. 